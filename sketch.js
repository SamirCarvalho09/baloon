...
var blue = createSprite(0, Math.round(ramdom(20,370)), 10, 10)
blue.addImage(blue_ballonImage);
blue.velocityX = 3;
blue.lifetime = 150
pin.scale = 0.1;

var pink = createSprite(0, Math.round(ramdom(20,370)), 10, 10)
pink.addImage(pink_ballonImage).velocityX = 3;
pink.lifetime = 150
pin.scale = 0.1;

var green = createSprite(0, Math.round(ramdom(20,370)), 10, 10)
